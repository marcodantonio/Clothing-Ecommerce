      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-xl-9 mb-5 mb-lg-0">
            <form method="POST" enctype="multipart/form-data" action="./functions/insert_andress.php">
              <!-- Invoice Address-->
              <h3 class="mb-4"> Invoice address                    </h3>
              <div class="row">
                <div class="form-group col-md-6">
                    <label class="form-label" for="fullname_invoice">Full Name</label>
                    <input class="form-control" type="text" name="fullname" placeholder="Joe Black" id="fullname_invoice" pattern="[A-Za-z ]{0,}" required>
                  </div>
                  <div class="form-group col-md-6">
                      <label class="form-label" for="emailaddress_invoice">Email Address</label>
                      <input class="form-control" type="text" name="email" placeholder="joe.black@gmail.com" id="emailaddress_invoice" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[a-z]{2,}$">
                  </div>
              <div class="form-group col-md-6">
                  <label class="form-label" for="state_invoice">State</label>
                  <input class="form-control" type="text" name="stato" placeholder="State" id="state_invoice" pattern="[A-Za-z']{0,}" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="street_invoice">Street</label>
                  <input class="form-control" type="text" name="via" placeholder="123 Main St." id="street_invoice" pattern="[A-Za-z0-9.' ]{0,}" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="city_invoice">City</label>
                  <input class="form-control" type="text" name="citta" placeholder="City" id="city_invoice" pattern="[A-Za-z' ]{0,}" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="zip_invoice">CAP</label>
                  <input class="form-control" type="text" name="cap" placeholder="Postal code" id="zip_invoice" pattern="[0-9]{5}" required>
                </div>
              ...
              <?php
              $result=select_backup_indirizzo_utente($connect, $id);

              ?>

              <div class="container">
                  <h2>Indirizzi</h2>
                  <p>Qui in basso potrai vedere gli indirizzi associati a questo account</p>
                  <table class="table table-hover" style="text-align: center">
                              ...
                              //if(!empty(mysqli_fetch_array($result))){
                                  while($row = mysqli_fetch_array($result)){
                                    ...
                                    echo"<tr>
                                        ...
                                        <td>$cap</td>
                                        <td>$stato</td>
                                        <td><a class='btn btn-outline-primary' href='./functions/indirizzo_delete.php?id=$id'>Elimina</a></td>
                      ...
                      if($cont==0){
                      echo"<tr style='text-align: center'><td colspan='7'><b>Nessun Indirizzo associato a questo account</b></td></tr>";
                      }
            ...
            <div class="customer-sidebar card border-0">
                <div class="customer-profile"><h3 class="d-inline-block img-fluid rounded-circle customer-image" style="border:1px solid gray;"><?php echo $_SESSION['nome'][0] . " " . $_SESSION['cognome'][0]; ?></h3>
                  ...
                  <div class="badge badge-pill badge-dark font-weight-normal px-3"><?php $tot=select_totale_ordini_utente($connect, $_SESSION["id"]); echo $tot; ?></div>
                    ...
                    </svg>Profile</span></a><a class="active list-group-item d-flex justify-content-between align-items-center" href="customer-addresses.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content sidebar-cart-content">
          ...
          <div class="modal-footer sidebar-cart-footer shadow">
            <div class="w-100">
              <h5 class="mb-4">Subtotal: <span class="float-right">$465.32</span></h5><a class="btn btn-outline-dark btn-block mb-3" href="cart.php">View cart</a><a class="btn btn-dark btn-block" href="checkout.php">Checkout</a>
            </div>
          </div>
        </div>
      </div>
