    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <ol class="breadcrumb pl-0 ">
            <?php
            $result=select_ordine_utente($connect,$idordine);
             $valori=mysqli_fetch_array($result);
                $codice=$valori["codice"];
                  $fullname=$valori["fullname"];
                  $email=$valori["email"];
                  $data=$valori["data"];
                  $stato_ordine=$valori["stato_ordine"];
          ...
          <li class="breadcrumb-item active">Order <?php echo  "#$codice" ; ?>        </li>
        </ol>
        <!-- Hero Content-->
        <div class="hero-content">
          <h1 class="hero-heading">Order <?php echo  "#$codice" ; ?>  </h1>
          <div><p class="lead text-muted">Order <?php echo  "#$codice" ; ?> was placed on <strong><?php echo  "$data" ; ?>  </strong> and is currently <strong><?php echo  "$stato_ordine" ; ?></strong>.</p>
              </div>
        </div>
      </div>
    </section>
              ...
              <div class="cart-wrapper">
                <div class="cart-header">
                  <div class="row">
                    ...
                    <div class="col-2 text-right">Total</div>                </div>
                </div>
                <div class="cart-body">
                  <!-- Product-->
<?php
                    $result=select_prodotti_ordine_utente_costo($connect,$idordine);
                    while($row = mysqli_fetch_array($result)){ 
                        $idprodotto=$row["id"];
                        $codice_articolo=$row["codice_articolo"];
                        $nomep=$row["nomeprodotto"];
                        $foto=$row["immagine"];
                        $taglia=$row["taglia"];
                        $colore=$row["colore"];
      ...
      echo"           <div class='cart-item'>
                    <div class='row d-flex align-items-center text-center'>
                      <div class='col-6'> 
                        <div class='d-flex align-items-center'><img class='cart-item-img' src=\"backend/upload/$foto\"></a>
                          <div class='cart-title text-left'><strong>$nomep</strong></a><br><span class='text-muted text-sm'>Size: $taglia</span><br><span class='text-muted text-sm'>Colour: $colore</span>
                          </div>
                        </div>
                      </div>
                      <div class='col-2'>$$costo</div>
                      <div class='col-2'>$quantita
                      </div>
                      <div class='col-2 text-center'>$$sub_totale</div>
                    </div></div>";}
?>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table card-text">
                        ...
                        <?php
                        $dati=select_ordine_utente_costo($connect, $idordine);
                        $totale=0;
                      ...
                      <tr>
                        ...
                        <td class="py-4 text-right text-muted"><?php echo  "$$totale" ; ?></td>
                      </tr>
                      <tr>
                        <th class="py-4">Shipping and handling</th>
                        <td class="py-4 text-right text-muted"><?php echo  "$$spedizione" ; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="py-4 text-right h3 font-weight-normal"><?php echo  "$$totale_iva" ; ?></td>
                      </tr>
                    </table>
                  </div>
                </div>
              ...
              <div class="col-md-6">
                <div class="card mb-4">
                  ...
                  <div class="card-body p-4">
                    <p class="card-text text-muted"><?php echo  "<b> Nome: </b> $fullname" ; ?><br><?php echo "<b>Email: </b>$email"; ?> <br><?php echo  "<b>Via: </b>$via " ; ?><br><?php echo  "<b>Stato: </b> $stato, $citta $cap" ; ?></strong></p>
                  </div>
                </div>
