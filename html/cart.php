...
<?php
  ...
  <body>
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted" id="testo">You have 3 items in your cart.</p> <p class="lead text-muted">Continue <a href="./category-sidebar.php">Shopping</a> or return to your <a href="customer-account.php">account</a>.</p></div>
             <?php
      if($err==1){ 
        echo"<div class='d-block' id='addToCartAlert'>
          <div class='mb-4 mb-lg-5 alert alert-success' id='alert' role='alert' style='background-color:#ff0000;display:block'>
            <div class='d-flex align-items-center pr-3'>
              ...
              <p class='mb-0'>La quantità non può essere inferiore a 1!<br class='d-inline-block d-lg-none'></p>
            </div>
        ...
        echo"<div class='d-block' id='addToCartAlert'>
          <div class='mb-4 mb-lg-5 alert alert-success' id='alert' role='alert' style='background-color:#ff0000;display:block'>
            <div class='d-flex align-items-center pr-3'>
              ...
              <p class='mb-0'>Quantità non disponibile!<br class='d-inline-block d-lg-none'></p>
            </div>
            <button class='close close-absolute close-centered opacity-10 text-inherit' type='button' data-dismiss='alert' aria-label='Close'>
              <svg class='svg-icon w-2rem h-2rem'>
                <use xlink:href='#close-1'> </use>
          ...
          <div class="col-lg-8 pr-xl-5">
           ...
           <?php
             ...
             echo"   <div class='cart-item'>
                  <div class='row d-flex align-items-center text-left text-md-center'>
                    <div class='col-12 col-md-5'><a class='cart-remove close mt-3 d-md-none' href=''><i class='fa fa-times'></i></a>
                      <div class='d-flex align-items-center'><a href='detail-1.php?id=$idP&wish=0&car=0&taglia=$taglia'><img class='cart-item-img' src=\"backend/upload/$foto\"></a>
                        <div class='cart-title text-left'><a class='text-dark link-animated' href='detail-1.php?id=$idP&wish=0&car=0&taglia=$taglia'><strong>$nome_prodotto</strong></a><br><span class='text-muted text-sm'>Size: $taglia</span><br><span class='text-muted text-sm'>Colour: $colore</span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class='row align-items-center'>
                          ...
                          <div class='row align-items-center'>
                            ...
                            <div class='col-5 col-sm-3 col-md-12'>
                              <div class='d-flex align-items-center'>
                                <input class='form-control text-center border-0 border-md input-items' type='text' value='$quantita' id='$idP' name='$taglia' onchange='prendi(this.id, this.value, this.name)'>
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class='col-md-3'> 
                          <div class='row'>
                            ...
                            <div class='col-6 col-md-12 text-right text-md-center'>$$tot_prodotto</div>
                          </div>
                        </div>
                        <div class='col-2 d-none d-md-block text-center'><a class='cart-remove text-muted' href='./functions/carrello_delete.php?idC=$idC&idP=$idP&taglia=$taglia&pro=0'> 
                  ...
                  echo"<script>document.getElementById('testo').innerHTML = 'You have $num_prodotti items in your cart.'</script>";
            ...
            if($tot_prodotti==0){
                ...
                echo"<div style='text-align: center'><p><b>Nessun capo nel carrello</b></p><br></div>";
            }
             echo"<div class='d-flex justify-content-between flex-column flex-lg-row mb-5 mb-lg-0'>
                <a class='btn btn-link text-muted' href='category-sidebar.php'><i class='fa fa-chevron-left'></i> Continue Shopping</a>";

           if($tot_prodotti!=0){

                echo"
               
                <a class='btn btn-link text-primary' href='./checkout.php'> Checkout </a>
               ";
            }
                  ?>
              ...
              <div class="card-body py-4">
                ...
                <table class="table card-text">
                  ...
                  <tr>
                    ...
                    <td class="py-4 text-right text-muted"> $0</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td class="pt-4 text-right h3 font-weight-normal"><?php echo "$$totale_iva"; ?></td>
                  </tr>
                </table>
    ...
    <script>
                ...
                function prendi(id, value, name){
                    
              <?php 

                    echo"window.open('./functions/update_carrello.php?idprodotto='+id+'&taglia='+name+'&newquantita='+value, name='_self')"; ?>
