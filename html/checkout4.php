        ...
        <div class="row">
          <div class="col-lg-8">
            <ul class="custom-nav nav nav-pills mb-5">
              ...
              <li class="nav-item w-25"><a class="nav-link text-sm " href="checkout2.php">Delivery Method</a></li>
              <li class="nav-item w-25"><a class="nav-link text-sm " href="checkout3.php">Payment Method </a></li>
              <li class="nav-item w-25"><a class="nav-link text-sm active" href="checkout4.php">Order Review</a></li>
            </ul>
            <div class="mb-5">
              <div class="cart">
              ...
              echo"      <div class='cart-item'>
                      <div class='row d-flex align-items-center text-center'>
                        <div class='col-6'>
                          <div class='d-flex align-items-center'><a href='detail.php?id=$idP&wish=0&car=0&taglia=$taglia'><img class='cart-item-img' src=\"backend/upload/$foto\"></a>
                            <div class='cart-title text-left'><a class='text-dark' href='detail.php?id=$idP&wish=0&car=0&taglia=$taglia''><strong>$nome_prodotto</strong></a><br><span class='text-muted text-sm'>Size: $taglia</span>
                            </div>
                          </div>
                        </div>
                        <div class='col-2'>";if(!$sconto){ echo"$$costo";}  else { echo" $$prezzoscontato ";}echo"</div>
                        <div class='col-2'>$quantita
                        </div>
                        <div class='col-2 text-center'>$$tot_prodotto</div>
                      </div>
                    </div>";}
            $iva=($tot_prodotti*22)/100;
            $totale_iva=$tot_prodotti+$iva;
            $_SESSION["totalecosto"]=$totale_iva;
                      ?>
            ...
            <div class="mb-5 d-flex justify-content-between flex-column flex-lg-row"><a class="btn btn-link text-muted" href="checkout3.php"> <i class="fa fa-angle-left mr-2"></i>Back to the delivery method</a><a class="btn btn-dark" href="checkout-confirmed.php">Place an order<i class="fa fa-angle-right ml-2"></i></a></div>
          </div>
          <div class="col-lg-4">
            <div class="card mb-5"> 
                ...
                <p class="text-muted text-sm">Shipping and additional costs are calculated based on values you have entered.</p>
                 <table class="table card-text">
                  ...
                  <tr>
                    ...
                    <td class="py-4 text-right text-muted"> $5</td>
                  </tr>
                  <tr>
