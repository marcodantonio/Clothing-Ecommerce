              ...
              <h3 class="mb-4"> Invoice address                    </h3>
                ...
                <div id="accordion" role="tablist">
                            ...
                            <div class="card-body py-5">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="fullname" placeholder="Joe Black" id="fullname_invoice"  pattern="[A-Za-z ]{0,}" value="<?php if(isset($_SESSION['indirizzo_nome'])){echo $_SESSION['indirizzo_nome'];} ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                    ...
                    <?php
                        ...
                        $result=select_backup_indirizzo_utente($connect, $_SESSION["id"]);


                            echo"<div id='contr' class='card border-0 shadow mb-3' style='display: block'><a class='accordion-link collapsed' data-toggle='collapse' href='#collapseThree' aria-expanded='false' aria-controls='collapseThree' onclick='prendi(0,0)'>Account addresses</a></div>
                        <div class='collapse' id='collapseThree' role='tabpanel' aria-labelledby='headingThree' data-parent='#accordion'>";
                            ...
                            while($row = mysqli_fetch_array($result)){
                                ...
                                <div class='card-radio mb-4'>
                                        ...
                                        <input class='card-radio-input' type='radio' name='shippping' id='$id' onclick='prendi(this.id,1)'>
                                        <div class='card'>
                                            <div class='card-header'>
                                                <h6 class='mb-0'>Indirizzo: $via</h6>
                                            </div>
                                            <div class='card-body'>
                                                <p class='text-muted text-sm'>Nome completo: $fullname <br> Email:$email <br> Stato: $stato, Città: $citta <br> Via $via $cap</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>";
    ...
    <footer>
       ...
       <?php
        ...
        if(isset($_POST["invia"])){
            ...
            //$a=$_COOKIE['cond_indirizzo'];
           //echo"<script>alert($a);</script>";
            //$_COOKIE['cond_indirizzo']=0;
