        ...
        <div class="row">
          <div class="col-lg-8">
              <ul class="custom-nav nav nav-pills mb-5">
                  ...
                  <li class="nav-item w-25"><a class="nav-link text-sm <?php if(!isset($_COOKIE['idconsegna'])){ echo'disabled';}  ?>" href="checkout4.php">Order Review</a></li>
              </ul>
            ...
            <div class="mb-5">
              <div id="accordion" role="tablist">
                <div class="card border-0 shadow mb-3">
                  ...
                  <?php
                             $result=select_carta_utente($connect, $_SESSION["id"]);
                             if($result){
                 echo" <div class='card border-0 shadow mb-3'>
                          <div class='card-header accordion-header' id='headingTwo' role='tab'><a class='accordion-link collapsed' data-toggle='collapse' href='#collapseTwo' aria-expanded='false' aria-controls='collapseTwo' onclick='prendi(2,0)'>Account's credit card</a></div>
                     ...
                     while($row = mysqli_fetch_array($result)){
                                    ...
                                    $numero_nascosto=substr($numero,0,5);

                                    $fin=substr($numero,11,4);
            ...
            echo"
                                ...
                                <div class='card-radio mb-4'>
                                        <label class='card-label' for='$id'></label>
                                        <input class='card-radio-input' type='radio' name='shippping' id='$id' onclick='prendi(this.id)'>
                                        <div class='card'>
                                            <div class='card-header'>
                                                <h6 class='mb-0'>$numero_nascosto - **** - **** - $fin </h6>
                                            </div>
                                            <div class='card-body '>
                                            <table>
                                                <tr>
                                                    <td class='text-muted text-sm'>Proprietario:</td>
                                                    <td class='text-muted text-sm'>&emsp;$proprietario</td>
                                                
                                                </tr>
                                                <tr>
                                                    <td class='text-muted text-sm'>Data Scadenza</td>
                                                    <td class='text-muted text-sm'>&emsp;$data_scadenza</td>
                ...
                <div class="card border-0 shadow mb-3">
                  <div class="card-header accordion-header" id="headingTwo" role="tab"><a class="accordion-link collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" onclick="prendi('alla_consegna',0)">Pay on delivery</a></div>
                  <div class="collapse" id="collapseThree" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body py-5">
                      ...
                      <div >
                        ...
                        <label for="payment-method-2"> <span class="d-block h6 mt-1 mb-3"> Pay on delivery</span><span class="text-muted text-sm">If possible, payment on delivery can be made. Everything will be managed through communications with the customer who requests it</span></label>
                      </div>
        ...
        if($_COOKIE['cond_consegna']==1){
             if(empty($_POST['card-name']) or
                ...
                empty($_POST['cvv'])){
                 ...
                 echo"<script>document.location.href = './checkout4.php';</script>";
            }}
