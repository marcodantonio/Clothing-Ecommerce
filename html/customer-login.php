...
$query="SELECT * FROM Sito where id=1";
    ...
    $titolo_pagina=$valori["titolo_pagina"];
    $titolo_login=$valori["titolo_login"];
    $titolo_registrazione=$valori["titolo_registrazione"];
    $descrizione_login=$valori["descrizione_login"];
    $descrizione_registrazione=$valori["descrizione_registrazione"];
?>
  <head>
    <meta charset="utf-8">
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="text-muted"><?php echo"$titolo_pagina"; ?></p></div>
        </div>
      </div>
    </section>
    <!-- customer login-->
        ...
        <div class="d-block" id="addToCartAlert">
          <div class="mb-4 mb-lg-5 alert alert-success" id="alert" role="alert" style="background-color:#ff0000;display:none">
            <div class="d-flex align-items-center pr-3">
              ...
              <p class="mb-0">Le credenziali immesse sono errate! <br class="d-inline-block d-lg-none"></p>
            </div>
        ...
        <div class="row">
          <div class="col-lg-5">
            <div class="card">
              ...
              <div class="card-body p-5">
                <p class="lead"><?php echo"$titolo_login"; ?></p>
                <p class="text-muted text-sm"><?php echo"$descrizione_login"; ?></p>
                <hr class="my-4">
                <form method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                  <div class="form-group">
                    <label class="form-label" for="emailLogin">Email</label>
                    <input class="form-control" id="emailLogin" type="text" name="emailL">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="passwordLogin">Password</label>
                    <input class="form-control" id="passwordLogin" type="password" name="passwordL">
                  </div>
                  <button class="btn btn-dark" type="submit" name="accedi"><i class="fa fa-sign-in-alt mr-2"></i> Log in</button>
                </form>
              </div>
            </div>
          </div>
          <div class="col-lg-5 offset-lg-1">
            <div class="card">
              ...
              <div class="card-body p-5">
                <p class="lead"><?php echo"$titolo_registrazione"; ?></p>
                <p class="text-muted text-sm"><?php echo"$descrizione_registrazione"; ?></p>
                <hr class="my-4">
            <form method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                  <div class="form-group">
                    <label class="form-label" for="name">Name</label>
                    <input class="form-control" id="name" type="text" name="nomeR">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="name">Cognome</label>
                    <input class="form-control" id="name" type="text" name="cognomeR">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="emailSignup">Email</label>
                    <input class="form-control" id="emailSignup" type="text" name="emailR">
                  </div>
                  <div class="form-group">
                    <label class="form-label" for="passwordSignup">Password</label>
                    <input class="form-control" id="passwordSignup" type="password" name="passwordR">
                  </div>
                  <button class="btn btn-dark" type="submit" name="registrati"><i class="far fa-user mr-2" ></i>Register</button>
                </form>
              </div>
            </div>
          </div>
 ...
 <?php
    ...
    if(isset($_POST["registrati"])){    
        ...
        sing_in($connect,$nome,$cognome, $email, $password);
        $rt=login($connect,$email,$password); 
...
//}
      ...
      if(isset($_POST["accedi"])){
        ...
        if ($rt){
            ...
            if($_SESSION['ruolo']=='Amministratore' || $_SESSION['ruolo']=='Proprietario' && !isset($_SESSION["NEGRO"])){
