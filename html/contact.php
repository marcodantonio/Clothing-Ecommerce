      ...
      <div class="container">       
        <div class="row">
          <div class="col-md-4 text-center text-md-left mb-4 mb-md-0">
            <h4>Address</h4>
              <?php 
              $info=explode(",", $andress);
              
              ?>
            <p class="text-muted"><?php echo"$info[0]<br>$info[1],<strong>$info[2]</strong>"; ?> </p>
          </div>
          <div class="col-md-4 text-center text-md-left mb-4 mb-md-0">
            <h4>Call center</h4>
            <p class="text-muted"><?php echo"$callcenter";?></p>
            <p class="text-muted"><strong><?php echo"+39 $Call_Center_Number";?></strong></p>
          </div>
          <div class="col-md-4 text-center text-md-left">
            <h4>Electronic support</h4>
            <p class="text-muted"><?php echo"$eletronic_support";?></p>
            <ul class="list-unstyled text-muted">
              <li><?php echo"$Electronic_support_Number";?></li>
            ...
            <div class="d-block" id="addToCartAlert" >
                <div class="mb-4 mb-lg-5 alert alert-success" id="alert" role="alert" style="display:none;">
                    <div class="d-flex align-items-center pr-3">
                        ...
                        <p class="mb-0">Grazie per il tuo feedback! Registrati alla nostra casella di posta per ricevere altro!<br class="d-inline-block d-lg-none"></p>
                    </div>
    ...
    <section class="bg-gray-200 position-relative overflow-hidden">
      <div class="container-fluid">
        <div class="row">
          ...
          echo"  <div class='row py-4 border-bottom'>
              <div class='col-6 col-md-3 font-weight-bold align-self-center'>
                <h4 class='mb-0'>$nome</h4>
              </div>
              <div class='col-6 col-md-3 text-sm'>$indirizzo</div>
              <div class='col-6 col-md-3 text-sm'>+39 $numero</div>
              <div class='col-6 col-md-3 text-sm'>$email</div>
            </div>";}
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-8 col-xl-6 ml-auto">
            <form class="form" id="contact-form" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label class="form-label" for="nameContact">Your firstname *</label>
                  <input class="form-control form-control-underlined" type="text" id="name" required="required" name="nome">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <label class="form-label" for="surnameContact">Your lastname *</label>
                  <input class="form-control form-control-underlined" type="text" id="surname" required="required" name="cognome">
                </div>
              </div>
            </div>
            <div class="form-group">
              <label class="form-label" for="emailContact">Your email *</label>
              <input class="form-control form-control-underlined" type="email"  id="email" required="required" name="email">
            </div>
            <div class="form-group">
              <label class="form-label" for="messageContact">Your message for us *</label>
              <textarea class="form-control form-control-underlined" rows="4"  id="message" required="required" name="messaggio"></textarea>
            </div>
            <button class="btn btn-outline-primary mt-3" type="submit" name="andonio">Send message</button></form>
          </div>
        </div>
      </div>
    </section>
...
<?php
    if(isset($_POST["andonio"])){
$nome=$_POST["nome"];
$cognome=$_POST["cognome"];
$messaggio=$_POST["messaggio"];

$email=$_POST["email"];
        $query="INSERT into email_ricevute VALUES ('', '$nome', '$cognome', '$email', '$messaggio')";
            $dati=mysqli_query($connect, $query);
