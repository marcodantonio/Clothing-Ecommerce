       ...
       echo" 
          <div class='mb-4 mb-lg-5 alert alert-success' role='alert'>
            <div class='d-flex align-items-center pr-3'>
              ...
              <p class='mb-0'>Il prodotto è stato inserito nel carrello! <br class='d-inline-block d-lg-none'><a href='cart.php?err=0' class='text-reset text-decoration-underline ml-lg-3'>View carrello</a></p>
            </div>
...
if($wish==2){ 
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted mb-0" id="testo">You have 3 items in your wishlist.</p></div>
        </div>
      </div>
    </section>
    <!-- Wishlist Section-->
          ...
          <div class="cart mb-5 mb-lg-0">
            <div class="cart-body">
              <!-- Product-->
                ...
                $result=wishlist_accesso($connect,$_SESSION['id']);
                $idC=$_SESSION['id'];
                $tot=0;
                ...
                if($sconto) {
                    ...
                    echo"<div class='cart-item' style='display:block'>
                <div class='row d-flex align-items-center text-left text-md-center'>
                  <div class='col-12 col-md-5'><a class='cart-remove close mt-3 d-md-none' href='#'><i class='fa fa-times'></i></a><a class='d-md-none' href='#'>
                    ...
                    <div class='d-flex align-items-center'><a href='detail-1.php?id=$idP&wish=0&car=0&taglia=$taglia'><img class='cart-item-img' src=\"backend/upload/$foto\" alt='...'></a>
                      <div class='cart-title text-left'><a class='text-dark' href='detail-1.php?id=$idP&wish=0&car=0&taglia=$taglia'><strong>$nome_prodotto</strong></a><br><span class='text-muted text-sm'>Size: $taglia</span><br><span class='text-muted text-sm'>Colour: $colore</span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class='row align-items-center'>
                      <div class='col-md-2'>
                        <div class='row'>
                          ...
                          <div class='col-6 col-md-12 text-right text-md-center'>";if(!$sconto){ echo"$$costo";}  else { echo"<del style='color:red'>$$costo</del> $$prezzoscontato ";} echo"</div>
                        </div>
                      </div>";
                    if($quantita>0){
                      ...
                      <div class='col-md-4 d-none d-md-block text-center'> <a class='mt-4 mt-md-0 text-primary' href='./functions/insert_carrello_from_wishlist.php?idC=$idC&idP=$idP&taglia=$taglia'>
                          <svg class='svg-icon w-2rem h-2rem'>
                            <use xlink:href='#add-to-cart-1'> </use>
                          </svg></a>
                      </div>";}
                      ...
                      echo"
                      <div class='col-1 d-none d-md-block text-center'><a class='cart-remove text-muted' href='./functions/wishlist_delete.php?idP=$idP&idL=$idL&taglia=$taglia'> 
 ...
 ";
                ...
                <div class='row d-flex align-items-center text-left text-md-center'>
                  <div class='col-12 col-md-5'><a class='cart-remove close mt-3 d-md-none' href=''><i class='fa fa-times'></i></a><a class='d-md-none' href=''>
                      <svg class='svg-icon w-2rem h-2rem mt-2 mr-5 float-right'>
                        ...
                        <div class='row'>
                          <div class='col-6 col-md-12 text-right text-md-center'>Nessun capo inserito nella lista desideri</div>
                        </div>
  ...
  ";
                ...
                echo"<script>document.getElementById('testo').innerHTML = 'You have $tot items in your wishlist.'</script>";
                ?>
        ...
        <div class="col-xl-3 col-lg-4 mb-5">
          <div class="customer-sidebar card border-0">
              <div class="customer-profile"><h3 class="d-inline-block img-fluid rounded-circle customer-image" style="border:1px solid gray;"><?php echo $_SESSION['nome'][0] . " " . $_SESSION['cognome'][0]; ?></h3>
                  ...
                  <div class="badge badge-pill badge-dark font-weight-normal px-3"><?php $tot=select_totale_ordini_utente($connect, $_SESSION["id"]); echo $tot; ?></div>
                  ...
                  </svg>Credit Card</span></a><a class="active list-group-item d-flex justify-content-between align-items-center" href="customer-wishlist.php?wish=0"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#heart-1"> </use>
                    </svg>Wishlist</span><div class="badge badge-pill badge-light font-weight-normal px-3"><?php $tot=select_totale_wishlist_utente($connect, $_SESSION["id"]); echo $tot; ?></div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content sidebar-cart-content">
          ...
          <div class="modal-body px-5 sidebar-cart-body">
            ...
            <div class="sidebar-cart-product-wrapper custom-scrollbar">
              ...
              <div class="navbar-cart-product"> 
                <div class="d-flex align-items-center"><a href="detail-1.php"><img class="img-fluid navbar-cart-product-image" src="img/product/product-square-kyle-loftus-596319-unsplash.jpg" alt="..."/></a>
                  <div class="w-100"><a class="close" href="#">
                      <svg class="svg-icon sidebar-cart-icon">
                        <use xlink:href="#close-1"> </use>
                      </svg></a>
                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated" href="detail-1.php">Transparent Blouse</a><small class="d-block text-muted">Quantity: 1 </small><strong class="d-block text-sm">$75.00     </strong></div>
                  </div>
                </div>
              </div>
              <!-- cart item-->
              <div class="navbar-cart-product"> 
                <div class="d-flex align-items-center"><a href="detail-1.php"><img class="img-fluid navbar-cart-product-image" src="img/product/product-square-serrah-galos-494312-unsplash.jpg" alt="..."/></a>
                  <div class="w-100"><a class="close" href="#">
                      <svg class="svg-icon sidebar-cart-icon">
                        <use xlink:href="#close-1"> </use>
                      </svg></a>
                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated" href="detail-1.php">White Tee</a><small class="d-block text-muted">Quantity: 1 </small><strong class="d-block text-sm">$75.00     </strong></div>
                  </div>
                </div>
              </div>
              <!-- cart item-->
              <div class="navbar-cart-product"> 
                <div class="d-flex align-items-center"><a href="detail-1.php"><img class="img-fluid navbar-cart-product-image" src="img/product/product-square-ian-dooley-347968-unsplash.jpg" alt="..."/></a>
                  <div class="w-100"><a class="close" href="#">
                      <svg class="svg-icon sidebar-cart-icon">
                        <use xlink:href="#close-1"> </use>
                      </svg></a>
                    <div class="pl-3"> <a class="navbar-cart-product-link text-dark link-animated" href="detail-1.php">Skull Tee</a><small class="d-block text-muted">Quantity: 1 </small><strong class="d-block text-sm">$75.00     </strong></div>
                  </div>
                </div>
              </div>
              <!-- cart item-->
          ...
          <div class="modal-footer sidebar-cart-footer shadow">
            <div class="w-100">
              <h5 class="mb-4">Subtotal: <span class="float-right">$465.32</span></h5><a class="btn btn-outline-dark btn-block mb-3" href="cart.php?err=0">View cart</a><a class="btn btn-dark btn-block" href="checkout.php">Checkout</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="modal-body p-5">
            ...
            <div class="tab-content">
              <div class="tab-pane active fade show px-3" id="loginModalTabLogin" role="tabpanel" aria-labelledby="loginModalLinkLogin">
                <form action="customer-orders.php" method="get">
