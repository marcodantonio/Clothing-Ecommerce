...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted"></p></div>
        </div>
      </div>
    </section>
    <section class="pb-6">
          ...
          <div class="col-lg-8 col-xl-9 mb-5 mb-lg-0">
            <div class="mb-5">
              <h3 class="mb-5">Change your password</h3>
                ...
                <div class="d-block" id="addToCartAlert">
                    <div class="mb-4 mb-lg-5 alert alert-success" id="alert1" role="alert" style="background-color:#ff0000;display:none">
                        <div class="d-flex align-items-center pr-3">
                            ...
                            <p class="mb-0">La vecchia password non coincide con quella attuale! <br class="d-inline-block d-lg-none"></p>
                        </div>
                ...
                <div class="d-block" id="addToCartAlert">
                    <div class="mb-4 mb-lg-5 alert alert-success" id="alert2" role="alert" style="background-color:#ff0000;display:none">
                        <div class="d-flex align-items-center pr-3">
                            <svg class="svg-icon d-none d-sm-block w-3rem h-3rem svg-icon-light flex-shrink-0 mr-3">
                                <use xlink:href="#delete-circle-1"> </use>
                            </svg>
                            <p class="mb-0">Le due password non coincidono <br class="d-inline-block d-lg-none"></p>
                        </div>
                        <button class="close close-absolute close-centered opacity-10 text-inherit" type="button" data-dismiss="alert" aria-label="Close">
                            <svg class="svg-icon w-2rem h-2rem">
                                <use xlink:href="#close-1"> </use>
                ...
                <div class="d-block" id="addToCartAlert">
                    <div class="mb-4 mb-lg-5 alert alert-success" id="alert3" role="alert" style="display:none">
                        <div class="d-flex align-items-center pr-3">
                            <svg class="svg-icon d-none d-sm-block w-3rem h-3rem svg-icon-light flex-shrink-0 mr-3">
                                <use xlink:href="#checked-circle-1"> </use>
                            </svg>
                            <p class="mb-0">Password modificata con successo<br class="d-inline-block d-lg-none"></p>
                        </div>
                        <button class="close close-absolute close-centered opacity-10 text-inherit" type="button" data-dismiss="alert" aria-label="Close">
                            <svg class="svg-icon w-2rem h-2rem">
                                <use xlink:href="#close-1"> </use>
                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="password_old" type="password" name="op" required>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" id="password_1" type="password" name="np" required>
                    </div>
                  </div>
                  <div class="col-sm-6">
                    <div class="form-group">
                      <label class="form-label" for="password_2">Retype new password</label>
                      <input class="form-control" id="password_2" type="password" name="rnp" required>
                    </div>
                  </div>
                </div>
                <div class="mt-4">
                  <button class="btn btn-dark" type="submit" name="change_password"><i class="far fa-save mr-2"></i>Change password</button>
                </div>
              </form>
            </div>
            <hr class="mb-5">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="nome" value="<?php echo $nome; ?>" type="text" required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="form-label" for="lastname">Last name</label>
                    <input class="form-control" name="cognome" value="<?php echo $cognome; ?>" type="text" required>
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-sm-6 col-md-3">
                      <div class="form-group">
                          ...
                          <input class="form-control" value="<?php echo $telefono; ?>" name="telefono" type="text" pattern="[0-9]{10}" title="Inserire solo numeri">
                      </div>
                  </div>
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                    <label class="form-label" for="zip">Fax</label>
                    <input class="form-control" id="zip" name="fax" value="<?php echo $fax; ?>" type="text" >
                  </div>
                </div>
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" id="emailAccount" name="email" value="<?php echo $email; ?>" type="text" required>
                  </div>
                </div>
              </div>
              <!-- /.row-->
              <div class="mt-4"></div>
              <button class="btn btn-dark" type="submit" name="personal_detail"><i class="far fa-save mr-2"></i>Save changes</button>
            </form>
          </div>
          <!-- Customer Sidebar-->
          <div class="col-xl-3 col-lg-4 mb-5">
            <div class="customer-sidebar card border-0">
                <div class="customer-profile"><h3 class="d-inline-block img-fluid rounded-circle customer-image" style="border:1px solid gray;"><?php echo $_SESSION['nome'][0] . " " . $_SESSION['cognome'][0]; ?></h3>
                  ...
                  </a><a class="active list-group-item d-flex justify-content-between align-items-center" href="customer-account.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
    ...
    if(isset($_POST["personal_detail"])){
        ...
        update_info($connect, $id, $nome,$cognome,$email, $telefono, $fax); //VEDERE LA FUNZIONE
    ...
    if(isset($_POST["change_password"])){
        ...
        $rptnuovaPSW=$_POST["rnp"];
         ...
         $ris=update_password($connect,$id,$vecchiaPSW,$nuovaPSW, $rptnuovaPSW);
