                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 139px;">Cognome</th>
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Base Price: activate to sort column ascending" style="width: 147px;">Telefono</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Residenza</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 121px;">CAP</th>
                                                                      <?php if($a=='Proprietario'){ echo"<th class='sorting' tabindex='0' aria-controls='order-listing' rowspan='1'  aria-label='Actions: activate to sort column ascending' style='text-align:center;width: 118px;'>Actions</th><th class='sorting' tabindex='0' aria-controls='order-listing' rowspan='1'  aria-label='Actions: activate to sort column ascending' style='text-align:center;width: 118px;'>Actions</th>";} ?>
                                                           ...
                                                           <?php
                                                                    ...
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        <td>$citta $via</td>
                                                                        <td>$cap</td>";
                                                                       if($a=='Proprietario'){ echo" <td><a class='btn btn-facebook' href='../functions/utente_upgrade.php?id=$cod' onclick='return conferma()'>Upgrade</a></td>
                                                                        <td><a class='btn btn-google' href='../functions/utente_delete.php?id=$cod' onclick='return conferma1()'>Delete</a></td>";}
