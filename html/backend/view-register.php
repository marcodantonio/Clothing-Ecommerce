                      ...
                      <div class="row"> <!----------------------------------------------------------------------------------- ------------------->
                          ...
                          <div class="content-wrapper" style="max-width: 50%">
                              <div class="card" style="border-radius: 1rem">
                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Cognome</th>
                                 ...
                                 ";
                                                                      if($a=='Proprietario'){ echo" <td><a class='btn btn-google' href='../functions/emailricevute_delete.php?id=$cod' onclick='return conferma1()'>Delete</a></td>";}
                                                  ...
                                                  <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  //$result=select_utente(connection());
                                                                  $cont=1;
                                                                  $query="SELECT * FROM email_registrate";
                                                                  $result=mysqli_query(connection(), $query);
                                                                  ...
                                                                  while($row = mysqli_fetch_array($result)){
                                                                      ...
                                                                      echo" <tr>  
                                                                        ...
                                                                        <td>$email</td>
                                 ";
                                                                      if($a=='Proprietario'){ echo" <td><a class='btn btn-google' href='../functions/emailregistrate_delete.php?id=$cod' onclick='return conferma1()'>Delete</a></td>";}
...
<script>
          ...
          if (confirm("Sicuro di voler eliminare l'email?"))
              return true;
          else
              return false;
