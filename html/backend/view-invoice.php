          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item dropdown">
              <a class="nav-link language-dropdown" id="userDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                  <p style="background-color: white; color:black;border:1px solid black; padding:1px">&emsp;Option&emsp;</p>
              </a>
...
$query="SELECT o.codice, o.via, o.cap, o.stato, o.citta, tipologia, nome, cognome,nome_corriere FROM ordine o join indirizzo i on (o.id_indirizzo=i.id) join corriere c on (o.id_corriere=c.id) join pagamento p on (o.id_pagamento=p.id) join utente_indirizzo ui ON (ui.id_indirizzo=i.id) join utente u on (ui.id_utente=u.id) where o.id=$id";
...
$stato=str_replace("&ap;", "'", $stato);
    $pagamento=$result["tipologia"];
    $nome=$result["nome"];
    $cognome=$result["cognome"];
    $corriere=$result["nome_corriere"];
                        ...
                        <div class='card px-2'>
                            <div class='card-body'>
                                <div class='container-fluid'>
                                    <h3 class='ext-right my-5'>Varkala E-commerce</h3>
                                    <h3 class='mt-5 mb-2 text-right'><b>Codice ordine:&nbsp;&nbsp;$codice</b></p>
                                ...
                                <div class='container-fluid d-flex justify-content-between'>
                                    <div class='col-lg-3 pl-0'>
                                        ...
                                        <p class='mt-5 mb-20'><b>Modalità pagamento</b></p>
                                        <p>$pagamento</p>
                                    </div>
                                    <div class='col-lg-3 pr-0'>
                                        <p class='mt-5 mb-2 text-right'><b>Spedito a</b></p>
                                        <p class='text-right'>$nome  $cognome </p>
                                        <p class='mt-5 mb-2 text-right'><b>Corriere</b></p>
                                        <p class='text-right'>$corriere </p>
                                    </div>
                                </div>";
                                ...
                                <div class='container-fluid mt-5 d-flex justify-content-center w-100'>
                                    <div class="table-responsive w-100">
                                        <table class="table">
                                            ...
                                            <tbody>
<?php
$result=select_prodotti_ordine_utente_costo($connect, $id); 
$totale=0;                                         
while($row = mysqli_fetch_array($result)){ 
    ...
    echo"
                                            <tr class='text-right'>
                                                <td class='text-left'>#$codice_articolo</td>
                                                <td class='text-left'>$nome</td>
                                            <td class='text-left'>$colore</td>
                                                <td class='text-left'>$taglia</td>
                                                <td>$quantita</td>
                                                <td>$$costo</td>
                                                <td>$$sub_totale</td>
                                            </tr>";}
...
$totale_iva+=$spedizione;
                    echo"
                                ...
                                <p class='text-right'>Total  : $$totale</p>
                                    <h4 class='text-right mb-5'>Total + iva + spedizione : $$totale_iva</h4>";
                                                ?>
                                    <hr>
                                </div>
