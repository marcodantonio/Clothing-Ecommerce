              ...
              <div class="row">
                  <div class="col-sm-12">
                      <div class="d-sm-flex justify-content-between align-items-center mb-4">
                          <div>
                                  <p class="text-small text-dark mb-1">Backend / Products</p>
                              <h4 class="font-weight-bold mb-0">Show Product</h4>
                          </div>
                      </div>
                  </div>
              </div>
                      ...
                      <div class="row"> <!----------------------------------------------------------------------------------- ------------------->
                          <div class="content-wrapper">
                              <div class="card" style="border-radius: 1rem">
                                  <div class="card-body">
                                      <h4 class="card-title">Prodotti Inseriti</h4>
                                      <div class="row">
                                          <div class="col-12">
                                              <div class="table-responsive">
                                                  <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-hover dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  <thead>
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 139px;">Colore</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Ship to: activate to sort column ascending" style="width: 112px;">Brand</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Base Price: activate to sort column ascending" style="width: 147px;">Costo</th>
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Categoria</th>
                                                                  ...
                                                                  <?php
                                                                    ...
                                                                    $result=select_prodotti_shop_backend($connect);
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        <td>$ $costo</td>
                                                                        <td>$categoria</td>
                                                                        <td><a class='btn btn-success' href='../detail-1.php?id=$idprodotto&car=0&wish=0&taglia=$tagliaI' target='_blank'>View</a></td>
                                                                        <td><a class='btn btn-facebook' href='./edit-product.php?id=$idprodotto'>Edit</a></td>
                                                                        <td><a class='btn btn-google' href='../functions/product_delete.php?id=$idprodotto' onclick='return elimina()'>Delete</a></td>
                                                                        </tr> ";} 
                         ?>
                                                                  </tbody>
                                                              </table>
