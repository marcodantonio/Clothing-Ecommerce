                                                      ...
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased Price: activate to sort column ascending" style="width: 211px;">Codice Prodotto</th>
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Customer: activate to sort column ascending" style="width: 139px;">Cognome Cliente</th>
                                                           ...
                                                           <?php
                                                                    ...
                                                                    $cont=1;
                                                                    $query="SELECT r.id, u.nome, cognome, codice_articolo, valutazione, dettaglio FROM recensione r JOIN utente u ON (u.id=r.id_utente) JOIN prodotto p ON (p.id=r.id_prodotto)";
                                                                    ...
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        <td>$valutazione</td>
                                                                        <td>$dettaglio</td>";
                                                                       if($a=='Proprietario'){ echo" <td><a class='btn btn-google' href='../functions/review_delete.php?id=$cod' onclick='return conferma1()'>Delete</a></td>";}
