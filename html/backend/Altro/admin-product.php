...
<html lang="en">
  ...
  <body>
    ...
    <header class="header header-absolute"> 
      <nav class="navbar navbar-expand-lg bg-transparent border-0 shadow-0 navbar-light px-lg-5 ">
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav mt-3 mt-lg-0">
            ...
            <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="iconsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Category</a>
              <div class="dropdown-menu py-lg-0" aria-labelledby="iconsDropdown" data-min-width="750px">
                <div class="row py-lg-5 px-4">
                  <div class="col-6 col-sm-3 col-md-2 text-center mb-2 mb-lg-5"><a class="text-reset" href="../category-sidebar.php">
                  ...
                  <div class="col-6 col-sm-3 col-md-2 text-center mb-2 mb-lg-5"><a class="text-reset" href="../category-sidebar.php">
                      ...
                      <h6>Scarf</h6></a></div>
                  <div class="col-6 col-sm-3 col-md-2 text-center mb-2 mb-lg-0"><a class="text-reset" href="../category-sidebar.php">
                      <svg class="svg-icon w-3rem h-3rem mb-2 svg-icon-light">
      ...
      <div class="container">
        ...
        <div class="hero-content">
          ...
          <div><p class="lead text-muted mb-0">Here you can manage all the affiliated couriers for the management of the deliveries of each order.</p></div>
        </div>
      </div>
    </section>
        ...
        <div class="col-lg-8 col-xl-9">
          <div class="cart mb-5 mb-lg-0">
            <div class="cart-body">
              ...
              <div class="container">  
               <h2 align="left"><b>In-Store Product</b></h2>  
               <div class="form-group mt-4">
                ...
                <th scope='col'>Elimina</th>
                    ...
                    <tr>
                        ...
                        <td ><center></center></td> 
                        <td ><center></center></td> 
                        <td><center><a data-toggle="modal" data-target="#quickView"><img src='../img/tables/scheda.jpg' height='35' width='35' title='Scheda'></a></center></td> 
                        <td><center><a data-toggle="modal" data-target="#quickViewMod"><img src='../img/tables/modifica.jpg' height='35' width='35' title='Modifica'></a></center></td>
                        <td><center><a><img src='../img/tables/cestino.jpg' height='35' width='35' title='Cestino'></a></center></td>
                        </tr>
                    <!--    //  <?php  
                        ...
                        //      $codice=$row['CODICE'];
                        //      $fotoP=$row['FOTO_P'];
                        //       $sceltasito=$row['SCELTA_SITO']; 
                        //    $ind=$row['INDIRIZZO'];$ind=str_replace("&ap;", "'", $ind);$ind=str_replace("&ec;", "è", $ind);$ind=str_replace("&oc;", "ò", $ind);
                        //        $ind=str_replace("&ac;", "à", $ind);$ind=str_replace("&uc;", "ù", $ind);$ind=str_replace("&ic;", "ì", $ind);
                        //    $comune=$row['COMUNE'];$comune=str_replace("&ap;", "'", $comune);$comune=str_replace("&ec;", "è", $comune);$comune=str_replace("&oc;", "ò", $comune);
                        //        $comune=str_replace("&ac;", "à", $comune);$comune=str_replace("&uc;", "ù", $comune);$comune=str_replace("&ic;", "ì", $comune);
                        //       echo "  
                        //       <tr>  
                        //            <td>".$row['TIPO_CONTRATTO']."</td> 
                        //            <td>".$sceltasito."</td>  
                        //            <td>";if($fotoP!=""){ echo"<img src='upload/$fotoP' width=\"114\" height=\"79\";";} echo"</td>
                        //            <td>".$ind."</td>  
                        //            <td>".$row['CAP']."</td>  
                        //            <td>".$comune."</td>  
                        //            <td>".$row['MQ_COMMERCIALE']."</td>

                        //    <td><center><a href='scheda_immobile.php?id=$codice'><img src='../Immagini/scheda.jpg' height='35' width='35' title='Scheda'></a></center></td>
                        //          <td><center><a href='modifica_immobile.php?id=$codice'><img src='../Immagini/modifica.jpg' height='35' width='35'title='Modifica'></center></a></td>
                        //          <td><center><a href='elimina_immobile.php?id=$codice' onclick='return elimina()'><img src='../Immagini/cestino.jpg' height='35' width='35'35title='Elimina'></a></center></td>
        ...
        <div class="col-xl-3 col-lg-4 mb-5">
            <div class="customer-sidebar card border-0"> 
              <div class="customer-profile"><a class="d-inline-block" href="#"><img class="img-fluid rounded-circle customer-image" src="img/avatar/avatar-0.jpg" alt=""></a>
                <h5>Jane Doe</h5>
                <p class="text-muted text-sm mb-0">Administrator</p>
              </div>
              <nav class="list-group customer-nav"><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-account.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#paper-bag-1"> </use>
                    </svg>Profile</span>
                  </a><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-users.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#real-estate-1"> </use>
                    </svg>Users</span></a><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-permissions.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#male-user-1"> </use>
                    </svg>Permission</span></a><a class="active list-group-item d-flex justify-content-between align-items-center" href="admin-product.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#heart-1"> </use>
                    </svg>Products</span></a><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-orders.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#heart-1"> </use>
                    </svg>Orders</span></a><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-couriers.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#exit-1"> </use>
                    </svg>Couriers</span></a><a class="list-group-item d-flex justify-content-between align-items-center" href="../customer-login.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                      <use xlink:href="#exit-1"> </use>
                    </svg>Log out</span></a>
              </nav>
    ...
    <div class="modal fade quickview" id="quickViewMod" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
          <button class="close close-absolute close-rotate" type="button" data-dismiss="modal" aria-label="Close">
            <svg class="svg-icon w-3rem h-3rem svg-icon-light align-middle">
          ...
          <div class="modal-body quickview-body">
            <div class="row">
              ...
              <div class="col-lg-6 p-lg-5"> <!--                                               --------------------------------------- ------------------------------------------ --------------------------------------- -->
                <h2 class="mb-4 mt-4 mt-lg-1">Push-up Jeaneeeeeeees</h2>
                <div class="d-flex flex-column flex-sm-row align-items-sm-center justify-content-sm-between mb-4">
                  <ul class="list-inline mb-2 mb-sm-0">
                    <li class="list-inline-item h4 font-weight-light mb-0">$65.00</li>
                    <li class="list-inline-item text-muted font-weight-light"> 
