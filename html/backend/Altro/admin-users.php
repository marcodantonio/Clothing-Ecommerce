    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          <h1 class="hero-heading">Users</h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-xl-9 mb-5 mb-lg-0">
            <form action="#">
              <!-- Invoice Address                                 onkeyup="myFunction()"   -->
              <div id="" style="display:block">
           <br /><br />  
                  
           <div class="container">  
               <h2 align="left"><b>Subscribers Users</b></h2>
            <hr class="mb-5"> 
              <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                    <input class="search form-control"  id="myInput" onkeyup="myFunction()" type="text" placeholder='Search'>
                  </div>
                </div>
                <br />  
               ...
               <th scope='col'><center>Cognome</center></th>
               <th scope='col'><center>Gruppo</center></th>
               <th scope='col'><center>Azione</center></th>
          ...
          <div class="col-xl-3 col-lg-4 mb-5">
            <div class="customer-sidebar card border-0"> 
              ...
              <nav class="list-group customer-nav"><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-account.php"><span>
                  ...
                  </a><a class="active list-group-item d-flex justify-content-between align-items-center" href="admin-users.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
                    ...
                    </svg>Permission</span></a><a class="list-group-item d-flex justify-content-between align-items-center" href="admin-product.php"><span>
                    <svg class="svg-icon svg-icon-heavy mr-2">
