        ...
        <div class="row">
          <div class="col-lg-8 col-xl-9 mb-5 mb-lg-0">
            ...
            <form>
              ...
              <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="form-label" for="lastname">Number</label>
                            <input class="form-control" id="lastname" type="text">
                        </div>
                    </div>   
              </div>
              ...
              <div class="row">
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                    <label class="form-label" for="phone">Expiration date</label>
                    <input class="form-control" id="phone" type="text">
                  </div>
                </div>
                <div class="col-sm-6 col-md-3">
                  <div class="form-group">
                    <label class="form-label" for="zip">CVV</label>
                    <input class="form-control" id="zip" type="text">
                  </div>
                </div>
                <div class="col-sm-6"> <!--                                         METTERE IMMAGINI CARTE DI CREDITO ----------------------->
                  <div class="form-group">
                    <img src="../img/credit-card.png" style="max-width:250px;padding:40px;">
                  </div>
                </div>                <!--                 ---------------------->
              </div>
              <!-- /.row                                                          -->
          ...
          <div class="col-xl-3 col-lg-4 mb-5">
            <div class="customer-sidebar card border-0"> 
              ...
              <nav class="list-group customer-nav"><a class="active list-group-item d-flex justify-content-between align-items-center" href="admin-account.php"><span>
