          ...
          <div class="content-wrapper">
              ...
              <div class="card" style="border-radius: 1rem">
                  <div class="card-body m-4">
                      <h4 class="card-title">Info for Ansima product</h4>
                      ...
                      <!--<form class="forms-sample">-->
                          ...
                          <div class="form-group row pb-4 p-3" style="background-color:#EAC564; border-radius:1rem">
                              <table style="align-content: center; margin-top:1.5rem; margin-right:1rem; color:white">
                                  <tr><td><label><b>Nome Colore</b></label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="colore" style=' width: 200px;height: 35px'></td>&nbsp;
                                  </tr>
                              </table>
                              <table style="align-content: center; margin-top:1.5rem; margin-right:1rem; color:white">
                                  <tr><td><label><b>Colore</b></label></td></tr>
                                  <tr>
                                      <td><input value="#3399FF80" style='width: 200px;height: 35px' name="coloret" data-jscolor="{}"></td>
                                  </tr>
                              </table>

                              <table style="align-content: center; margin-top:1.5rem; margin-right:1rem; color:white" class="b-3">
                                  <tr><td><label><b>Nome Brand</b></label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="brand" style=' width: 200px;height: 35px'></td>&nbsp;
                                  </tr>
                              </table>
                              <table style="align-content: center; margin-top:1.5rem; margin-right:1rem; color:white">
                                  <tr><td><label><b>Taglia</b></label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="taglia" style=' width: 200px;height: 35px'></td>
                                  </tr>
                              </table>
                              <table style="align-content: center; margin-top:1.5rem; margin-right:1rem; color:white">
                                  <tr><td><label><b>Categoria</b></label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="categoria" style='width: 200px;height: 35px;'></td>&nbsp;
                                  </tr>
                              </table>
                              <table style="align-content: center; margin-top:1.5rem; color:white">
                                  <tr><td><label><b>SVG   (maggiori informazioni <a style="color:#262b3a" href="../icons/svg-clothes.html" target="_blank">qui</a>)</label></td></tr>
                                  <tr>
                                      <td><input class="form-control" name="svgg" style=' width: 200px;height: 35px'></td>
                                  </tr>
                              </table>
                              </div>
                          </div>
                          <center><button type="sumbit" class="btn btn-success btn-icon-text " name="registra">
...
<center>
                      <div class="row" style="text-align: center;"> <!-----------------------------------------------------------------------------------                    ------------------->
                              <div class="card" style="max-width: 500px; border-radius: 1rem; margin: 2rem">
                                  <div class="card-body">
                                      <h4 class="card-title">Colori Registrati</h4>
                                      <div class="row">
                                          <div class="col-12">
                                              <div class="table-responsive">
                                                  <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  <thead>
                                                                 
                                                                  <tr role="row">
                                                                      <th class="sorting_asc" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Order #: activate to sort column descending" style="width: 115px;">Colore</th>
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="3" aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                                  ...
                                                                  <tbody>
                                                                   ...
                                                                   $cont=1;
                                                                    ...
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        $hex=$row['hexcode'];
                                                                        echo" <tr>  
                                                                        <td><center><div id='circle' style='background:$hex;border: solid black 1px;'></div></center></td> 
                                                                        <td>$nome</td>
                                                                        <td><a class='btn btn-google' href='../functions/colore_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
                              ...
                              <div class="card" style="max-width: 500px; border-radius: 1rem; margin: 2rem">
                                  <div class="card-body">
                                      <h4 class="card-title">Brand Registrati</h4>
                                      <div class="row">
                                          <div class="col-12">
                                              <div class="table-responsive">
                                                  <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                      <div class="row"><div class="col-sm-12 col-md-6">
                                                              ...
                                                              <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                                  ...
                                                                  <tr role="row">
                                                                      ...
                                                                      <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 185px;">Brand</th><th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="3" aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                                  ...
                                                                  <tbody>
                                                                    ...
                                                                    while($row = mysqli_fetch_array($result)){
                                                                        ...
                                                                        <td>$cont</td> 
                                                                        <td>$nome</td>
                                                                        <td><a class='btn btn-google' href='../functions/brand_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
                      ...
                      <div class="row" style="text-align: center">
                          <div class="card" style="max-width: 500px; border-radius: 1rem; margin: 2rem">
                          <div class="card-body">
                              <h4 class="card-title">Taglie Registrate</h4>
                              <div class="row">
                                  <div class="col-12">
                                      <div class="table-responsive">
                                          <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                              <div class="row"><div class="col-sm-12 col-md-6">
                                                      ...
                                                      <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                          ...
                                                          <tr role="row">
                                                              <th class="sorting_asc" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Order #: activate to sort column descending" style="width: 115px;">Codice</th>
                                                              <th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="1" aria-label="Purchased On: activate to sort column ascending" style="width: 185px;">Taglie</th><th class="sorting" tabindex="0" aria-controls="order-listing" rowspan="1" colspan="3" aria-label="Actions: activate to sort column ascending" style="text-align:center;width: 118px;">Actions</th>
                                                          ...
                                                          while($row = mysqli_fetch_array($result)){
                                                              ...
                                                              echo" <tr>  
                                                                        <td>$cont</td> 
                                                                        <td>$nome</td>
                                                                        <td><a class='btn btn-google' href='../functions/taglia_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
                          ...
                          <div class="card" style="max-width: 500px; border-radius: 1rem; margin: 2rem">
                              <div class="card-body" >
                                  <h4 class="card-title">Categorie Registrate</h4>
                                  <div class="row">
                                      <div class="col-12">
                                          <div class="table-responsive">
                                              <div id="order-listing_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4 no-footer">
                                                          ...
                                                          <table id="order-listing" class="table-borderless dataTable no-footer" role="grid" aria-describedby="order-listing_info">
                                                              ...
                                                              while($row = mysqli_fetch_array($result)){
                                                                  ...
                                                                  echo" <tr>  
                                                                        ...
                                                                        <td>$nome</td>
                                                                        <td>
                                                                        <svg style='max-width: 20px;max-height: 20px'>
                                                                                <use xlink:href='$svg' ></use>
                                                                            </svg>
                                                                        </td>
                                                                       
                                                                        <td><a class='btn btn-google' href='../functions/categoria_delete.php?id=$cod' onclick='return elimina()'>Delete</a></td>
...
$colore=$_POST["colore"];
$coloret=$_POST['coloret'];
$brand=$_POST["brand"];
$taglia=$_POST["taglia"];
$categoria=$_POST["categoria"];
$svg=$_POST["svgg"];
//echo"<script>alert($svg)</script>";

    if($brand)
    insert_brand($connect,$brand);
    if($colore)
    insert_colore($connect,$colore,$coloret);
    if($taglia)
    insert_taglia($connect,$taglia);
    if(($categoria)&&($svg))
    insert_categoria($connect,$categoria,$svg);
    header("location: ./info-product.php");
}
