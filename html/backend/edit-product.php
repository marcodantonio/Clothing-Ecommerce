    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center" style="background-color : #182150"> <!-- dfedf0 -->
        <div class="d-flex justify-content-between align-items-center" ><br>
            <p1 class="navbar-brand brand-logo" style="text-align: center; color: white;">Varkala</p1>
        <!--  <div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link language-dropdown" id="userDropdown" data-toggle="dropdown" aria-expanded="false">
                        <p style="text-align:center;background-color: white; border:2px solid #F4D875;color:black;border-radius: 20px; padding:1px">&emsp;<?php echo '<b>' . $_SESSION['nome'] .  ' ' . $_SESSION['cognome'] . '&emsp;<br>&emsp;' . $_SESSION['ruolo'] .'</b>'; ?>&emsp;</p>
                    </a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
          <div class="content-wrapper">
              ...
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title">New product for Varkala's shop</h4>
                      <p class="card-description">Here you can insert all details about a product that will be insert inside the virtual store</p>
                    
                      <form class="forms-sample" method="POST" enctype="multipart/form-data" action="./comp-edit-product.php">
                                       
                          <div class="form-group row">
                            <?php
                                $result=select_prodotto($connect, $idG);
                                
                                $idprodotto=$result['id'];
                                $codV=$result['codice_articolo'];
                                $nomeV=$result['nome'];
                                $fotoV=$result['foto'];
                                $coloreV=$result['colore'];
                                $scontoV=$result['codice_sconto'];
                                $brandV=$result['brand'];
                                ...
                                //$tagliaV=$result['taglia'];
                                //$quantitaV=$result['quantita'];
                                $descrizione1V=$result['descrizione1'];
                                $descrizione2V=$result['descrizione2'];
                                $materiale=$result['materiale'];
                                $vestibilita=$result["vestibilita"];
                                //$id_taglia=$result["id_taglia"];
...
echo"
                             ...
                             <div class='col'>
                                  ...
                                  <input class='form-control' name='materiale' value='$materiale' style='border: 0.5px solid grey'>
                            </div>
                             <div class='col'>
                                  <label>Vestibilità</label>
                                  <input class='form-control' name='vestibilita' value='$vestibilita' style='border: 0.5px solid grey'>
    ...
    ?>
                          ...
                          <div class="form-group row">
                              ...
                              $_SESSION["arrayT"]=array();

                              
                                $result=select_prodotto_taglie($connect, $idG);
                                    while($row = mysqli_fetch_array($result)){
                                        
                                        $quantita=$row["quantita"];
                                        $taglia=$row["tipologia"];
                                        $arrayQ[$count]=$quantita;
                                        array_push($_SESSION["arrayQ"],$quantita);
                                        $arrayT[$count]=$taglia;
                                        array_push($_SESSION["arrayT"],$taglia);
                              ...
                              $count=0;
                              while($count<5){
                              if(!isset($arrayQ[$count]))
                                  $arrayQ[$count]="";
                              $count++;}
                              
                              $count=0;
                              while($count<5){
                              if(!isset($arrayT[$count]))
                                  $arrayT[$count]="";
                              $count++;}?>
                           ...
                           <?php
                                echo"
                             <div class='col' style='border: #0a0a0a 1px solid'>
                                  <center>
                                      <br>
                                      <label><b>Quantità</b></label>
                                      <input class='form-control' name='quantita' style='border: 0.5px solid grey' value='$arrayQ[0]'>
                                      <br>
                                      <label><b>Taglia</b></label><br>
                                      <select name='taglia' class='tabella2'>";
                                    echo"<option value='$arrayT[0]'>$arrayT[0]</option>";
                         ...
                         echo"   
                             ...
                             <div class='col' style='border: #0a0a0a 1px solid'>
                                  <center>
                                      <br>
                                      <label><b>Quantità</b></label>
                                      <input class='form-control' name='quantita1' style='border: 0.5px solid grey' value='$arrayQ[1]'>
                                      <br>
                                      <label><b>Taglia</b></label><br>
                                      <select name='taglia1' class='tabella2'>";
                                    echo"<option value='$arrayT[1]'>$arrayT[1]</option>";
                                    $result=select_taglia($connect);
                                             while($row = mysqli_fetch_array($result)){
                                                 $taglia=$row["tipologia"];
                                                if($arrayT[1]!=$taglia)  
                             ...
                             <div class='col' style='border: #0a0a0a 1px solid'>
                                  <center>
                                      <br>
                                      <label><b>Quantità</b></label>
                                      <input class='form-control' name='quantita2' style='border: 0.5px solid grey' value='$arrayQ[2]'>
                                      <br>
                                      <label><b>Taglia</b></label><br>
                                      <select name='taglia2' class='tabella2'>";
                                    echo"<option value='$arrayT[2]'>$arrayT[2]</option>";
                                    $result=select_taglia($connect);
                                             while($row = mysqli_fetch_array($result)){
                                                 $taglia=$row["tipologia"];
                                                if($arrayT[2]!=$taglia)  
                             ...
                             <div class='col' style='border: #0a0a0a 1px solid'>
                                  <center>
                                      <br>
                                      <label><b>Quantità</b></label>
                                      <input class='form-control' name='quantita3' style='border: 0.5px solid grey' value='$arrayQ[3]'>
                                      <br>
                                      <label><b>Taglia</b></label><br>
                                      <select name='taglia3' class='tabella2'>";
                                    echo"<option value='$arrayT[3]'>$arrayT[3]</option>";
                                    $result=select_taglia($connect);
                                             while($row = mysqli_fetch_array($result)){
                                                 $taglia=$row["tipologia"];
                                                if($arrayT[3]!=$taglia)  
                             ...
                             <div class='col' style='border: #0a0a0a 1px solid'>
                                  <center>
                                      <br>
                                      <label><b>Quantità</b></label>
                                      <input class='form-control' name='quantita4' style='border: 0.5px solid grey' value='$arrayQ[4]'>
                                      <br>
                                      <label><b>Taglia</b></label><br>
                                      <select name='taglia4' class='tabella2'>";
                                    echo"<option value='$arrayT[4]'>$arrayT[4]</option>";
                                    $result=select_taglia($connect);
                                             while($row = mysqli_fetch_array($result)){
                                                 $taglia=$row["tipologia"];
                                                if($arrayT[4]!=$taglia)  
                              ...
                              <select name="tipologia">
                                  <?php
                                      echo"<option value='$tipologiaV'>$tipologiaV</option>";
                                                 if($tipologiaV=="Uomo")
                                     echo"<option value='Donna'>Donna</option>";
                                                   else
                                    echo"<option value='Uomo'>Uomo</option>";
...
?>
                              ...
                              <select name="colore">
                                  <?php
                                      echo"<option value='$coloreV'>$coloreV</option>";
...
?>
                      ...
                      <select name="brand">
                                      ...
                                      echo"<option value='$brandV'>$brandV</option>";
                             ...
                             echo" </select></div>&emsp;&emsp;&emsp;"; ?>
                             ...
                             echo"
                                ...
                                <label><b>Sconto</b></label><br>
                                          <select name='sconto'>
                                              <?php
                                         echo"<option value='$scontoV'>$scontoV</option>";
                                      ...
                                      <div class="card">
                                          <div class="card-body">
                                              ...
                                              <div id="quillExample1" class="quill-container ql-container ql-snow" >
                                                  ...
                                                  <?php
                                                  echo"
                                                  <textarea class='ql-editor' type='text' name='descriS'   contenteditable='true' style='width: 100%; height: 100%'>$descrizione2V</textarea>";
                                                  ?>
                          ...
                          <?php
                              ...
                              $_SESSION["arrayI"]=array();
                          $arrayI=array();
                          $cont=0;
                          $result=select_immagini_detail($connect, $idG);
                          while($row = mysqli_fetch_array($result)){
                              
                              $foto=$row["nome"];
                              array_push($_SESSION["arrayI"],$foto);
                              $arrayI[$cont]=$foto;
                            $cont++;}
                              ...
                              <div class="col-lg-4 grid-margin stretch-card">
                                  <div class="card">
                                      <div class="card-body">
                                          ...
                                          <div class="dropify-wrapper" style='border: 0.5px solid grey'><div class="dropify-message"><span class="file-icon"></span> <p>Drag and drop a file here or click</p><p class="dropify-error">Ooops, something wrong appended.</p></div><div class="dropify-loader"></div><div class="dropify-errors-container"><ul></ul></div>
                          ...
                          Upload
                              </button></center><br><br></div></div><br>
                                                                <?php
                              echo"
                              
                              <input type='text' style='display:none' name='idprodotto' value='$idprodotto'>";
