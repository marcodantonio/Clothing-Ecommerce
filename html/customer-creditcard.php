    ...
    <section class="hero py-6">
      <div class="container">
        ...
        <div class="hero-content">
          <h1 class="hero-heading">Credit card</h1>
        </div>
      </div>
    </section>
    <section class="pb-6">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-xl-9 mb-5 mb-lg-0">
            <form method="POST" enctype="multipart/form-data" action="./functions/insert_credito.php">
              <!-- Invoice Address-->
              <h3 class="mb-4">Info about your credit card                    </h3>
              <div class="row">
              <div class="form-group col-md-6">
                  <label class="form-label" for="state_invoice">Proprietario</label>
                  <input class="form-control" type="text" name="proprietario" placeholder="Name and Surname" id="state_invoice" pattern="[A-Za-z ]{1,}" title="Inserire il nome del proprietario" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="street_invoice">Numero</label>
                  <input class="form-control" type="text" name="numero" placeholder="Number" id="street_invoice" pattern="[0-9]{16}" title="Inserire il numero della carta" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="city_invoice">Data Scadenza</label>
                  <input class="form-control" type="date" name="data_scadenza" placeholder="Expiration date" id="city_invoice" title="Inserire la data di scadenza" required>
                </div>
                <div class="form-group col-md-6">
                  <label class="form-label" for="zip_invoice">CVV</label>
                  <input class="form-control" type="text" name="cvv" placeholder="Postal code" id="zip_invoice" pattern="[1-9]{3}" title="Solo 3 numeri" required>
                </div>
              ...
              <div class="form-group mt-4">
                <button class="btn btn-dark" type="submit" name="invia"><i name="" class="far fa-save mr-2"></i>Save changes</button>
              </div>
            </form>
                <br><br><br><br>
              ...
              $result=select_carta_utente($connect, $id);

              ?>

              <div class="container">
                  <h2>Your credit cards</h2>
                  <p>Qui in basso potrai vedere le carte di credito associate a questo account</p>
                      ...
                      <tbody>
                                  ...
                                  while($row = mysqli_fetch_array($result)){
                                   ...
                                   // $cvv=$row['cvv'];
                                    ...
                                    echo"<tr>
                                        ...
                                        <td>$numero</td>
                                        <td>$data_scadenza</td>
                                        <td><a class='btn btn-outline-primary' href='./functions/carta_delete.php?id=$id'>Elimina</a></td>
                             ...
                             // }
                              //else{
                                ...
                                // echo"<tr> 
                                  //      <td colspan='7'><center>No data avaiable</center></td>
                                    //  </tr>";
                              //}
                              if($cont==0){
                                  echo"<tr style='text-align: center'><td colspan='7'><b>Nessuna carta di credito associata a questo account</b></td></tr>";
                              }
                              ?>
            ...
            <div class="customer-sidebar card border-0">
                <div class="customer-profile"><h3 class="d-inline-block img-fluid rounded-circle customer-image" style="border:1px solid gray;"><?php echo $_SESSION['nome'][0] . " " . $_SESSION['cognome'][0]; ?></h3>
                  ...
                  <div class="badge badge-pill badge-dark font-weight-normal px-3"><?php $tot=select_totale_ordini_utente($connect, $_SESSION["id"]); echo $tot; ?></div>
                    ...
                    </svg>Addresses</span></a><a class="active list-group-item d-flex justify-content-between align-items-center" href="customer-creditcard.php"><span>
                  <svg class="svg-icon svg-icon-heavy mr-2">
        ...
        <div class="modal-content sidebar-cart-content">
          <div class="modal-header border-0">
            <button class="close modal-close close-rotate" type="button" data-dismiss="modal" aria-label="Close">
              <svg class="svg-icon w-3rem h-3rem svg-icon-dark align-middle">
